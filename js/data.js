...
const SEED_DEALS = [
  { id: 'd1',  partnerId: 'p1',  name: 'Deal 1 · Partner 1',  product: 'Sales Cloud',     amount: 120000, created: '2026-05-10', close: '2026-08-15', stage: 'Proposal',   seller: 'F. Costa'  },
  { id: 'd2',  partnerId: 'p1',  name: 'Deal 2 · Partner 1',  product: 'Service Cloud',   amount:  80000, created: '2026-06-01', close: '2026-11-20', stage: 'Demo - POC', seller: 'F. Costa'  },
  { id: 'd3',  partnerId: 'p2',  name: 'Deal 1 · Partner 2',  product: 'Data Cloud',      amount:  60000, created: '2026-06-15', close: '2026-09-10', stage: 'Discovery',  seller: 'F. Costa'  },
  { id: 'd4',  partnerId: 'p3',  name: 'Deal 1 · Partner 3',  product: 'Marketing Cloud', amount: 150000, created: '2026-04-20', close: '2026-09-05', stage: 'Proposal',   seller: 'M. Reyes'  },
  { id: 'd5',  partnerId: 'p3',  name: 'Deal 2 · Partner 3',  product: 'Platform',        amount:  90000, created: '2026-06-25', close: '2026-12-01', stage: 'Proposal',   seller: 'M. Reyes'  },
  { id: 'd6',  partnerId: 'p4',  name: 'Deal 1 · Partner 4',  product: 'Sales Cloud',     amount:  40000, created: '2026-05-30', close: '2026-08-28', stage: 'Won',        seller: 'J. Salas'  },
  { id: 'd7',  partnerId: 'p5',  name: 'Deal 1 · Partner 5',  product: 'Service Cloud',   amount:  55000, created: '2026-06-05', close: '2026-09-25', stage: 'Demo - POC', seller: 'D. Rojas'  },
  { id: 'd8',  partnerId: 'p6',  name: 'Deal 1 · Partner 6',  product: 'Sales Cloud',     amount:  30000, created: '2026-06-10', close: '2026-10-15', stage: 'Declined',   seller: 'D. Rojas'  },
  { id: 'd9',  partnerId: 'p7',  name: 'Deal 1 · Partner 7',  product: 'Data Cloud',      amount: 200000, created: '2026-03-15', close: '2026-08-20', stage: 'Proposal',   seller: 'S. Mora'   },
  { id: 'd10', partnerId: 'p7',  name: 'Deal 2 · Partner 7',  product: 'Service Cloud',   amount:  75000, created: '2026-06-20', close: '2026-11-10', stage: 'Demo - POC', seller: 'S. Mora'   },
  { id: 'd11', partnerId: 'p7',  name: 'Deal 3 · Partner 7',  product: 'Platform',        amount:  50000, created: '2026-01-10', close: '2026-06-30', stage: 'Won',        seller: 'S. Mora'   },
  { id: 'd12', partnerId: 'p8',  name: 'Deal 1 · Partner 8',  product: 'Marketing Cloud', amount:  45000, created: '2026-06-01', close: '2026-09-18', stage: 'Proposal',   seller: 'H. Cano'   },
  { id: 'd13', partnerId: 'p9',  name: 'Deal 1 · Partner 9',  product: 'Sales Cloud',     amount:  95000, created: '2026-05-05', close: '2026-09-30', stage: 'Proposal',   seller: 'R. Soto'   },
  { id: 'd14', partnerId: 'p9',  name: 'Deal 2 · Partner 9',  product: 'Data Cloud',      amount:  60000, created: '2026-06-12', close: '2026-12-05', stage: 'Discovery',  seller: 'R. Soto'   },
  { id: 'd15', partnerId: 'p10', name: 'Deal 1 · Partner 10', product: 'Service Cloud',   amount: 110000, created: '2026-04-01', close: '2026-08-10', stage: 'Won',        seller: 'N. Sosa'   },
  { id: 'd16', partnerId: 'p11', name: 'Deal 1 · Partner 11', product: 'Sales Cloud',     amount:  35000, created: '2026-06-18', close: '2026-10-20', stage: 'Lost',       seller: 'E. Vargas' },
  { id: 'd17', partnerId: 'p11', name: 'Deal 2 · Partner 11', product: 'Platform',        amount:  25000, created: '2026-02-20', close: '2027-02-15', stage: 'Proposal',   seller: 'E. Vargas' },
  /* historical closed deals (Won) — feed the Accuracy module for H1 2026 */
  { id: 'd18', partnerId: 'p3',  name: 'Deal 3 · Partner 3',  product: 'Sales Cloud',     amount:  80000, created: '2025-12-01', close: '2026-02-20', stage: 'Won',        seller: 'M. Reyes'  },
  { id: 'd19', partnerId: 'p10', name: 'Deal 2 · Partner 10', product: 'Data Cloud',      amount: 120000, created: '2026-01-10', close: '2026-03-15', stage: 'Won',        seller: 'N. Sosa'   },
  { id: 'd20', partnerId: 'p1',  name: 'Deal 3 · Partner 1',  product: 'Platform',        amount:  90000, created: '2026-02-01', close: '2026-04-22', stage: 'Won', actual: 85000, seller: 'F. Costa' },
  { id: 'd21', partnerId: 'p9',  name: 'Deal 3 · Partner 9',  product: 'Service Cloud',   amount:  70000, created: '2026-03-01', close: '2026-05-18', stage: 'Won',        seller: 'R. Soto'   },
  /* decided losses (feed partner accuracy) + a live current-month deal */
  { id: 'd22', partnerId: 'p3',  name: 'Deal 4 · Partner 3',  product: 'Platform',        amount:  20000, created: '2026-01-05', close: '2026-03-10', stage: 'Lost',       seller: 'M. Reyes'  },
  { id: 'd23', partnerId: 'p9',  name: 'Deal 4 · Partner 9',  product: 'Marketing Cloud', amount:  30000, created: '2026-02-10', close: '2026-06-05', stage: 'Lost',       seller: 'R. Soto'   },
  { id: 'd24', partnerId: 'p1',  name: 'Deal 4 · Partner 1',  product: 'Sales Cloud',     amount:  70000, created: '2026-06-20', close: '2026-07-28', stage: 'Proposal',   seller: 'F. Costa'  },
];
